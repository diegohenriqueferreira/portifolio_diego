...
function ExperienceSection({ experience, compact = false }) {
  // Define as classes base dependendo se a seção é compacta ou não
  const sectionClassName = compact
    ? "perf-section scroll-mt-24 min-w-0"
    : "section-shell perf-section scroll-mt-24";

  // Estilização da linha vertical da Timeline (gradiente do seu tema)
  ...
  return (
    <section id="experience" className={sectionClassName}>
      <SectionHeading eyebrow="Experiência" />
      
      <div className={timelineClassName}>
        {/* Mapeia o array de experiências vindo do JSON */}
